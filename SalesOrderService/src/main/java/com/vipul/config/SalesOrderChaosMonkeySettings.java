...
public class SalesOrderChaosMonkeySettings extends ChaosMonkeySettings {

	public SalesOrderChaosMonkeySettings() {
		super();
	}

	public SalesOrderChaosMonkeySettings(ChaosMonkeyProperties chaosMonkeyProperties2, AssaultProperties assaultProperties2,
