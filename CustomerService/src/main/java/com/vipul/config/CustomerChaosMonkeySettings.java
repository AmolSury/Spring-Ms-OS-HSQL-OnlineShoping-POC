...
public class CustomerChaosMonkeySettings extends ChaosMonkeySettings {

	public CustomerChaosMonkeySettings() {
		super();
	}

	public CustomerChaosMonkeySettings(ChaosMonkeyProperties chaosMonkeyProperties2, AssaultProperties assaultProperties2,
