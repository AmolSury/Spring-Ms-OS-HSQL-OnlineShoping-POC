...
@EnableConfigurationProperties({ CustomerChaosMonkeySettings.class, AssaultProperties.class, WatcherProperties.class })
public class CustomerChaosConfiguration {
	private static final Logger LOGGER = LoggerFactory.getLogger(ChaosMonkey.class);
	private final ChaosMonkeyProperties chaosMonkeyProperties;
	private final WatcherProperties watcherProperties;
	private final AssaultProperties assaultProperties;

	public CustomerChaosConfiguration(ChaosMonkeyProperties chaosMonkeyProperties, WatcherProperties watcherProperties,
			AssaultProperties assaultProperties) {
		this.chaosMonkeyProperties = chaosMonkeyProperties;
		this.watcherProperties = watcherProperties;
		this.assaultProperties = assaultProperties;
		LOGGER.info("Chaos Monkey - Customer Service");
	}

	@Primary
	@Bean
	public ChaosMonkeySettings settings() {
		return new CustomerChaosMonkeySettings(chaosMonkeyProperties, assaultProperties, watcherProperties);
	}
